...
class ExerciseRunner:
    ...
    def __init__(self, topo_file, log_dir, pcap_dir, switch_json, bmv2_exe='simple_switch', quiet=False):
        """ Initializes some attributes and reads the topology json. Does not
            ...
            Arguments:
                topo_file   : string  // A json file which describes the exercise's mininet topology
...
def get_args():
    ...
    parser.add_argument('-b', '--behavioral-exe', help='Path to behavioral executable', type=str, required=False, default='simple_switch')
